...
const ArtigoViewContent = ({ artigo, openAuthModal }) => {
  ...
  const handlePlayerClick = (season, episode) => {
    if (!user) {
      ...
      router.push(`/player/${artigo.slug}/${season.slug}/${episode.slug}`);
    }
  };
...
export default withAuthModal(ArtigoViewContent);
